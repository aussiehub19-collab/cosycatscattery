      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="p-6 bg-slate-900/50 border border-slate-800/80 rounded-2xl space-y-2 text-xs text-slate-400">
              <span className="font-bold text-amber-300 block">Delivery to Sydney, Melbourne & Beyond</span>
              <p className="leading-relaxed">
                We&apos;re based in Canberra and don&apos;t have branch offices in other cities, but we regularly arrange VIP flight delivery to Sydney, Melbourne, Brisbane, Adelaide, Perth, Hobart, and Darwin. Tell us your city above and our concierge will confirm the fastest delivery option.
              </p>
            </div>
          </div>
